...
@Component({
  selector: 'eqp-img-drawing',
  templateUrl: './eqp-img-drawing.component.html',
  styleUrls: ['./eqp-img-drawing.component.scss']
})
export class EqpImgDrawingComponent implements OnInit, AfterViewInit, OnChanges {
