...
@Component({
  selector: "app-eqp-range-header",
  templateUrl: "./eqp-range-header.component.html",
  styleUrls: ["./eqp-range-header.component.scss"],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EqpRangeHeaderComponent<D> implements OnDestroy {
